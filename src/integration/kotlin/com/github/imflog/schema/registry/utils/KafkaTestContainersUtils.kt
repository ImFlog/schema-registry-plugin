...
abstract class KafkaTestContainersUtils {
    ...
    companion object {
        private val DEFAULT_CONFLUENT_VERSION = System.getenv().getOrDefault("KAFKA_VERSION", "7.2.1")
        ...
        val schemaRegistryContainer: GenericContainer<*> by lazy {
            GenericContainer("confluentinc/cp-schema-registry:$DEFAULT_CONFLUENT_VERSION")
                .withNetwork(network)
